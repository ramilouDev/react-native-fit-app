...
export default function SignUpScreen() {
  ...
  const onVerifyPress = async () => {
    if (!isLoaded) return;
    if (!code) {
      Alert.alert("Error", "Please enter the verefication code");
      return;
    }
    setIsLoading(true);
    try {
            ...
            <View className="flex-1 justify-center">
              <View className="items-center mb-8">
                ...
                <Text className="text-lg text-gray-600 text-center">
                  We've have sent a verification code to {"\n"}
                  {emailAddress}
                </Text>
              </View>
              <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
                ...
                <TouchableOpacity
                  ...
                  disabled={isLoading}
                  className={`rounded-xl py-4 shadow-sm mb ${
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      >
          ...
          <View className="flex-1 justify-center">
            ...
            <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
              ...
              <Text className="text-xs text-gray-500 text-center mb-4">
                By signing up, you agree yo our Terms os Services and Privacy
                Policy
              </Text>
            </View>
        ...
        <View className="pb-6">
          <Text className="text-center text-gray-500 text-sm">
            Ready to transform your daily workout routine?
          </Text>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
